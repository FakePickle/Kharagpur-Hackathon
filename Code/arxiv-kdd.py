...
save_dir = "arxiv_papers_kdd"
os.makedirs(save_dir, exist_ok=True)

# Create a client for the arXiv API
client = arxiv.Client(page_size=100)  # Page size can be adjusted based on needs

# Search query to handle variations of "accepted by KDD"
search_query = (
    '"accepted by KDD" OR "accepted at KDD" OR "accepted to KDD" '
    'OR "accepted for KDD" OR "accepted in KDD"'
)
