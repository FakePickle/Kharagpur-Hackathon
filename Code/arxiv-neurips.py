...
# Search query to handle variations of "accepted by NeruIPS"
search_query = (
    '"accepted by NeruIPS" OR "accepted at NeruIPS" OR "accepted to NeruIPS" '
    'OR "accepted for NeruIPS" OR "accepted in NeruIPS"'
)
