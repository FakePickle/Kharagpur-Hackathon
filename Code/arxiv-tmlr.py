...
save_dir = "arxiv_papers_tmlr"
os.makedirs(save_dir, exist_ok=True)

# Create a client for the arXiv API
client = arxiv.Client(page_size=100)  # Page size can be adjusted based on needs

# Search query to handle variations of "accepted by TMLR"
search_query = (
    '"accepted by TMLR" OR "accepted at TMLR" OR "accepted to TMLR" '
    'OR "accepted for TMLR" OR "accepted in TMLR"'
)
